...
//     [Header("Fixed Dot Count")]
//     [SerializeField] private int maxDots = 4;
...
//         {
//             Debug.LogError(
//                 "PageScrollController: Content is not assigned!"
//             );
//             return;
//         }
...
//         {
//             Debug.LogError(
//                 "PageScrollController: ScrollRect is not assigned!"
//             );
//             return;
//         }
...
//         {
//             Debug.LogWarning(
//                 "PageScrollController: Content ke andar koi Page nahi hai."
//             );
//             return;
//         }
...
//         {
//             Debug.LogWarning(
//                 "PageScrollController: Dot Parent assign nahi hai."
//             );
//             return;
//         }
...
//         {
//             Debug.LogWarning(
//                 "PageScrollController: Dot Prefab assign nahi hai."
//             );
//             return;
//         }
...
//         // Hamesha maximum 4 dots create honge
//         int dotsToCreate = Mathf.Max(1, maxDots);
...
//                 newDot.GetComponent<RectTransform>();

//             if (dotRect != null)
//             {
//                 dotRect.sizeDelta =
//                     new Vector2(dotWidth, dotHeight);
//             }
...
//         // Current page ko 4 dots mein map karo
//         int selectedDot = 0;

//         if (totalPages > 1 && dots.Count > 1)
//         {
//             float pageProgress =
//                 (float)currentPage / (totalPages - 1);

//             selectedDot = Mathf.RoundToInt(
//                 pageProgress * (dots.Count - 1)
//             );
//         }

//         selectedDot = Mathf.Clamp(
//             selectedDot,
//             0,
//             dots.Count - 1
//         );
